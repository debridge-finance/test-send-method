...
export interface DeBridgeGateInterface extends utils.Interface {
  functions: {
    ...
    "getNativeTokenInfo(address)": FunctionFragment;
    "getRoleAdmin(bytes32)": FunctionFragment;
    "getSubmissionIdFrom(bytes32,uint256,uint256,address,uint256,(uint256,uint256,address,bytes,bytes),bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getNativeTokenInfo",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface DeBridgeGate extends BaseContract {
  ...
  functions: {
    ...
    getSubmissionIdFrom(
      ...
      _receiver: string,
      _nonce: BigNumberish,
      autoParams: SubmissionAutoParamsFromStruct,
      hasAutoParams: boolean,
      overrides?: CallOverrides
    ): Promise<[string]>;
    ...
    lockedClaim(overrides?: CallOverrides): Promise<[boolean]>;
